...
const successResponseWithData = function (res, msg, data,metadata = {}, option = {}) {
  const resData = {
    status: 200,
    message: msg,
    ...metadata,
...
const successResponseCreatingOrDelete = function (res, msg, data, option = {}) {
  const resData = {
    status: 201,
    message: msg,
    data,
...
const validationErrorWithData = function (res, msg, data = undefined, option = {}) {
  const resData = {
    status: 400,
    message: msg,
    data,
...
const forbiddenResponse = (res, msg, option = {}) => {
  const data = {
    status: 403,
    message: msg,
  };
...
module.exports = {
  ...
  successResponseCreatingOrDelete,
